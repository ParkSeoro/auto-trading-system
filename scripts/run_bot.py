...
def main() -> int:
    parser = argparse.ArgumentParser(description="Upbit crypto auto-trading bot")
    ...
    parser.add_argument("--timeframe", default="1d",
                        help="Primary timeframe (1m,5m,15m,30m,1h,4h,1d,1w)")
    ...
    bot = build_bot(mode=args.mode, markets=markets,
